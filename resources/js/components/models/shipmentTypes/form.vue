        ...
        <div class="card-body">
            <form method="POST" @submit="handleSubmit" accept-charset="UTF-8">
                ...
                <div class="form-group">
                    ...
                    >El nombre del tipo de envío es requerido.
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input
                            type="checkbox"
                            v-model="selected_shipment_type.addressRequired"
                            v-capitalize
                            id="address-required"
                            name="address-required"
                            class="form-check-input"
                        />
                        <label class="form-check-label" for="address-required">Dirección Requerida</label>
                    </div>
                </div>
        ...
        async store() {
            await this.$store.dispatch("store", {
                ...
                data: {
                    ...
                    address_required: this.selected_shipment_type.addressRequired,
                }
            })
                .then(async result => {
                    this.$v.$reset();
