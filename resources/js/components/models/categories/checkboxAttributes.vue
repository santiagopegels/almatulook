...
export default {
    ...
    computed: {
        ...mapGetters(["isLoading", "attributesAll", "selected_category"]),
        attributesIds: {
            set(val) {
                console.log(val)
                this.$store.state.selected_category.attributesIds = val;
            },
            get() {
                return this.$store.state.selected_category.attributesIds;
            },
        },
        hasAttributes() {
